...
# TestC 7-A: Basic footer with footer and summaries
cat > "$layout_file" << 'EOF'
{
  "theme": "Red",
...
echo "TestC 7-A: Basic footer with footer and summaries"
echo "------------------------------------------------"
"$tables_script" "$layout_file" "$data_file" $DEBUG_FLAG $DEBUG_LAYOUT_FLAG

# TestC 7-B: Footer with long footer and wrapping description
cat > "$layout_file" << 'EOF'
{
  "theme": "Blue",
...
# TestC 7-C: Footer with multiple summary types and centered tags
cat > "$layout_file" << 'EOF'
{
  "theme": "Red",
...
# TestC 7-D: Footer with breaking by category and right-aligned footer
cat > "$layout_file" << 'EOF'
{
  "theme": "Blue",
...
# TestC 7-E: Elaborate footer with full-width footer, summaries, and mixed justifications
cat > "$layout_file" << 'EOF'
{
  "theme": "Red",
